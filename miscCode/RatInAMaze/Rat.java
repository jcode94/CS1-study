...
public class Rat {
    ...
    prints the path int he form os 1s. Please note
    ...
    boolean solveMazeUtil(int maze[][], int x, int y, int sol[][]) {
        ...
        if (isSafe(maze, x, y) == true) {
            ...
            /* If move in y direction doesn't give 
            solution then move backward in x direction */
            if (solveMazeUtil(maze, x - 1, y, sol)) {
                return true;
            }

            /* If move in x direction doesn't give 
            solution then move upward in y direction */
            if (solveMazeUtil(maze, x, y - 1, sol)) {
                return true;
            }
